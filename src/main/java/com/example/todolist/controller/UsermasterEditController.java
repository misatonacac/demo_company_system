...
public class UsermasterEditController {
	...
	@GetMapping("/edit")
	public ModelAndView usermasterEdit(@RequestParam (value="user_id",required=false)String user_id,ModelAndView mv) {
		...
		}else {	UsermasterEdit user = usermasterEditRepository
		            .findById(user_id)
		            .orElseThrow(() ->
